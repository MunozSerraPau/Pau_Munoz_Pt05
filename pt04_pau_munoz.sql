...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2024 a las 02:50:52
...
CREATE TABLE IF NOT EXISTS `campeones` (
  `id` int(1) NOT NULL AUTO_INCREMENT COMMENT 'Id del Campio',
...
(1, 'Ahri', 'Ahri es una maga de mid con gran movilidad y control de masas, capaz de atraer a sus enemigos con su Encanto para luego desatar poderosas ráfagas de daño con sus orbes, lo que la convierte en una gran amenaza en duelos 1v1.', 'Mana', 'Mage', 'XinLu'),
...
(6, 'Yasuo', 'Yasuo es un duelista experto con alta movilidad y críticos devastadores. Utiliza el viento para bloquear ataques, deslizarse entre enemigos y desatar ciclones que levantan al equipo rival, ideal en peleas grupales.', 'Flow', 'Fighter', 'XinLu'),
(7, 'Senna', 'Senna es un support tirador que combina daño a distancia con habilidades de apoyo. Con su definitiva global y su capacidad de curar y dañar al mismo tiempo, es una campeona versátil que puede proteger y atacar.', 'Mana', 'Marksman', 'XinLu'),
...
(9, 'Zed', 'Zed es un asesino de energía que sobresale en eliminar objetivos vulnerables con sus sombras y daño explosivo. Su habilidad definitiva le permite entrar y salir de peleas rápidamente, asegurando muertes cruciales.', 'Energy', 'Assassin', 'XinLu'),
(10, 'Garen', 'Garen es un luchador tanque con regeneración pasiva y habilidades que le permiten dominar su línea. Con su Justicia Demaciana, puede eliminar rápidamente a los campeones enemigos con poca vida.', 'None', 'Fighter', 'XinLu'),
...
(16, 'Darius', 'Darius es un luchador dominante en la top lane que puede castigar fuertemente a sus oponentes con su hacha. Su definitiva, Guillotina Noxiana, le permite ejecutar a los enemigos con baja vida, resetando su uso.', 'Mana', 'Fighter', 'PauMunozSerra'),
...
(18, 'Miss Fortune', 'Miss Fortune es una tiradora con habilidades de gran daño en área. Su definitiva es devastadora en peleas en equipo, especialmente cuando consigue alinear a varios enemigos con su lluvia de balas.', 'Mana', 'Marksman', 'PauMunozSerra'),
(19, 'Nautilus', 'Nautilus es un tanque con gran capacidad de control de masas y habilidades para iniciar peleas. Su gancho y definitiva hacen de él un iniciador ideal en teamfights y un support resistente en la botlane.', 'Mana', 'Tank', 'PauMunozSerra'),
...
INSERT INTO `usuaris` (`nom`, `cognoms`, `correu`, `nickname`, `contrasenya`) VALUES
('Pau', 'Munoz Serra ', 'munozserrap@gmail.com', 'PauMunozSerra', '$2y$10$4E2JTKlrzjqtg7qxvbFIFOUd2kiYZmTQ9R.1D3GyVWlLm/UHpAwR2'),
